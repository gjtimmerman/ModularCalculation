...
namespace ModularUnitTests
{
	...
	public:
		...
		{
			std::string signature = "302C021427FBE13628A0AA7053E3C11CE6B4E7F40624C18F02146D9F22C0AA16841B26969166C692E92B41176232";
			std::list<std::string> results = ParseBERASNString(signature);
		...
		TEST_METHOD(TestECSecp256k1PublicPrivateKeyPair)
		{
			...
			ECKeyPair ecKeyPair(myEC, privateKey);
			ECDSA myEcDsa(ecKeyPair);
			Assert::IsTrue(myEcDsa.ecKeyPair.y.x == publicKeyX);
			Assert::IsTrue(myEcDsa.ecKeyPair.y.y == publicKeyY);
		}
		TEST_METHOD(TestSignatureECDSASecp256k1SignAndVerifySHA256Valid)
		{
		...
		TEST_METHOD(TestSignatureECDSASecp256k1SignAndVerifySHA256InValid)
		{
			...
			publicKey.x = publicKeyX;
			publicKey.y = publicKeyY;
			ECKeyPair myEcKeyPair(myEC, privateKey, publicKey);
			ECDSA myEcDsa(myEcKeyPair);
			std::string signature = myEcDsa.Sign(pHashBigEndian, len, false);
		...
		TEST_METHOD(TestSignatureECDSANISTP521SignAndVerifySHA256ValidNotDER)
		{
			unsigned char* pHashBigEndian = (unsigned char*)"\x25\xbd\xec\xae\x5c\x8b\xc7\x90\x5c\xbb\xda\x89\x48\x5a\xfe\xc7\xc6\x07\xd6\x0a\xc0\xb1\xd4\xea\x66\xc3\xca\x01\xd7\x59\x3d\x87";
			unsigned int len = 32;
			ModNumber mzero;
		...
		TEST_METHOD(TestSignatureECDSANISTP521SignAndVerifySHA256ValidDER)
		{
			unsigned char* pHashBigEndian = (unsigned char*)"\x25\xbd\xec\xae\x5c\x8b\xc7\x90\x5c\xbb\xda\x89\x48\x5a\xfe\xc7\xc6\x07\xd6\x0a\xc0\xb1\xd4\xea\x66\xc3\xca\x01\xd7\x59\x3d\x87";
			unsigned int len = 32;
			ModNumber mzero;
			...
			ECKeyPair ecKeyPair(myEC);
			ECDSA myEcDsa(ecKeyPair);
			std::string signature = myEcDsa.Sign(pHashBigEndian, len, true);
			bool valid = myEcDsa.Verify(pHashBigEndian, len, signature, true);
			Assert::IsTrue(valid);
		}
		TEST_METHOD(TestSignatureECDSANISTP521SignAndVerifySHA256InValid)
		{
			unsigned char* pHashBigEndian = (unsigned char*)"\x25\xbd\xec\xae\x5c\x8b\xc7\x90\x5c\xbb\xda\x89\x48\x5a\xfe\xc7\xc6\x07\xd6\x0a\xc0\xb1\xd4\xea\x66\xc3\xca\x01\xd7\x59\x3d\x87";
			unsigned int len = 32;
			ModNumber mzero;
		...
		TEST_METHOD(TestSignatureECDSASignAndVerifyNISTP224SHA256ValidRandomPrivateKey)
		{
			unsigned char* pHashBigEndian = (unsigned char*)"\x25\xbd\xec\xae\x5c\x8b\xc7\x90\x5c\xbb\xda\x89\x48\x5a\xfe\xc7\xc6\x07\xd6\x0a\xc0\xb1\xd4\xea\x66\xc3\xca\x01\xd7\x59\x3d\x87";
			unsigned int len = 32;
			ModNumber mzero;
		...
		TEST_METHOD(TestSignatureECDSASignAndVerifyNISTP384SHA256ValidRandomPrivateKey)
		{
			unsigned char* pHashBigEndian = (unsigned char*)"\x25\xbd\xec\xae\x5c\x8b\xc7\x90\x5c\xbb\xda\x89\x48\x5a\xfe\xc7\xc6\x07\xd6\x0a\xc0\xb1\xd4\xea\x66\xc3\xca\x01\xd7\x59\x3d\x87";
			unsigned int len = 32;
			ModNumber mzero;
		...
		TEST_METHOD(TestSignatureECDSASignAndVerifyNISTP384SHA256InvalidRandomPrivateKey)
		{
			unsigned char* pHashBigEndian = (unsigned char*)"\x25\xbd\xec\xae\x5c\x8b\xc7\x90\x5c\xbb\xda\x89\x48\x5a\xfe\xc7\xc6\x07\xd6\x0a\xc0\xb1\xd4\xea\x66\xc3\xca\x01\xd7\x59\x3d\x87";
			unsigned int len = 32;
			ModNumber mzero;
		...
		TEST_METHOD(TestECDHSharedSecretNISTP384)
		{
			ModNumber mzero;
			ModNumber p = ModNumber::stomn("fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffeffffffff0000000000000000ffffffff", 16);
			MultGroupMod mgm(p);
		...
		TEST_METHOD(TestECDHSharedSecretBrainPoolP192r1)
		{
			ModNumber mzero;
			...
			ECPoint g;
			g.IsAtInfinity = false;
			g.x = ModNumber::stomn("C0A0647EAAB6A48753B033C56CB0F0900A2F5C4853375FD6", 16);
			g.y = ModNumber::stomn("14B690866ABD5BB88B5F4828C1490002E6773FA2FA299B8F", 16);
			ModNumber n = ModNumber::stomn("C302F41D932A36CDA7A3462F9E9E916B5BE8F1029AC4ACC1", 16);
			ModNumber a = ModNumber::stomn("6A91174076B1E0E19C39C031FE8685C1CAE040E5C69A28EF", 16);
			ModNumber b = ModNumber::stomn("469A28EF7C28CCA3DC721D044F4496BCCA7EF4146FBF25C9", 16);
			EC myEC(mgm, g, n, a, b);
			ECKeyPair ecKeyPair1(myEC);
			ECKeyPair ecKeyPair2(myEC);
			ModNumber result1 = CalculateECDHSharedSecret(ecKeyPair1, ecKeyPair2);
		...
		TEST_METHOD(TestDHSharedSecretMODPDifferentGenerators)
		{
#if (MAXMOD == 2048/8)
			DHParameters dhParameters1;
			dhParameters1.Modulus = ModNumber::stomn("", 16);
			...
			dhParameters2.Generator = ModNumber(3ull);
			MultGroupMod mgm(dhParameters1.Modulus);
			dhParameters1.PrivateExp = GenerateDHPrivateKey(dhParameters1.Modulus);
			dhParameters2.PrivateExp = GenerateDHPrivateKey(dhParameters2.Modulus);
		...
		TEST_METHOD(TestDHTwoSharedSecretsMODP)
		{
			DHParameters dhParameters1;
#if (MAXMOD == 1024/8)
			dhParameters1.Modulus = ModNumber::stomn("", 16);
#elif (MAXMOD == 2048/8)
			dhParameters1.Modulus = ModNumber::stomn("", 16);
#elif(MAXMOD == 4096/8)
			dhParameters1.Modulus = ModNumber::stomn("", 16);
#endif
#if (MAXMOD == 1024/8 || MAXMOD == 2048/8 || MAXMOD == 4096/8)
			dhParameters1.Generator = ModNumber(2ull);
			DHParameters dhParameters2;
			dhParameters2.Modulus = dhParameters1.Modulus;
			dhParameters2.Generator = dhParameters1.Generator;
			MultGroupMod mgm(dhParameters1.Modulus);
			std::thread th1([&mgm, &dhParameters1] {
				dhParameters1.PrivateExp = GenerateDHPrivateKey(dhParameters1.Modulus);
				dhParameters1.Public = mgm.Exp(dhParameters1.Generator, dhParameters1.PrivateExp);
				});
			std::thread th2([&mgm, &dhParameters2] {
				dhParameters2.PrivateExp = GenerateDHPrivateKey(dhParameters2.Modulus);
			...
			th1.join();
			th2.join();
			ModNumber sharedSecret1;
			ModNumber sharedSecret2;
			std::thread th3([&sharedSecret1, &dhParameters1, &dhParameters2] {sharedSecret1 = CalculateDHSharedSecret(dhParameters1, dhParameters2); });
			std::thread th4([&sharedSecret2, &dhParameters1, &dhParameters2] {sharedSecret2 = CalculateDHSharedSecret(dhParameters2, dhParameters1); });
			th3.join();
			th4.join();
			Assert::IsTrue(sharedSecret1 == sharedSecret2);
...
//			std::string signature = "ô¬Â£GòÝÛµug)ö]6ƒýq‰²àËª¢ßk‚„Ù|ª¼kÜ¨‹Iù:Úªëßé éÒÅÿEðtJßc5";
		...
		TEST_METHOD(TestSignatureECDSASignNISTP521SHA256ValidRandomPrivateKey)
		{
			char* message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
			std::tuple<unsigned char*, ULONG> result = hash((unsigned char*)message, strlen(message));
			unsigned char* pHashBigEndian = std::get<0>(result);
		...
		TEST_METHOD(TestSignatureECDSASignNISTP521SHA256ValidGivenPrivateKeyCalculatedPubKey)
		{
			char* message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
			std::tuple<unsigned char*, ULONG> result = hash((unsigned char*)message, strlen(message));
			unsigned char* pHashBigEndian = std::get<0>(result);
		...
		TEST_METHOD(TestSignatureECDSASignNISTP521SHA256InValidRandomPrivateKey)
		{
			char* message1 = "Dit is een test om te zien of een signature geverifieerd kan worden!";
			std::tuple<unsigned char*, ULONG> result1 = hash((unsigned char*)message1, strlen(message1));
			unsigned char* pHashBigEndian1 = std::get<0>(result1);
		...
		TEST_METHOD(TestSignatureECDSAVerifyNISTP521SHA256ValidRandomPrivateKey)
		{
			char* message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
			std::tuple<unsigned char*, ULONG> result = hash((unsigned char*)message, strlen(message));
			unsigned char* pHashBigEndian = std::get<0>(result);
			...
			std::string signature = signECDsa(myEcDsa, pHashBigEndian, len, BCRYPT_ECC_CURVE_NISTP521);
			bool valid = myEcDsa.Verify( pHashBigEndian, len, signature, false);
			delete[] pHashBigEndian;
			Assert::IsTrue(valid);
		}
		TEST_METHOD(TestSignatureECDSAVerifyNISTP521SHA256InValidRandomPrivateKey)
		{
			char* message1 = "Dit is een test om te zien of een signature geverifieerd kan worden!";
			std::tuple<unsigned char*, ULONG> result1 = hash((unsigned char*)message1, strlen(message1));
			unsigned char* pHashBigEndian1 = std::get<0>(result1);
			...
			ECKeyPair ecKeyPair(myEC);
			ECDSA myEcDsa(ecKeyPair);
			std::string signature = signECDsa(myEcDsa, pHashBigEndian1, len1, BCRYPT_ECC_CURVE_NISTP521);
			bool valid = myEcDsa.Verify( pHashBigEndian2, len2, signature, false);
			delete[] pHashBigEndian1;
			delete[] pHashBigEndian2;
			Assert::IsFalse(valid);
		...
		TEST_METHOD(TestSignatureECDSASignNISTP224SHA256ValidRandomPrivateKey)
		{
			char* message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
			std::tuple<unsigned char*, ULONG> result = hash((unsigned char*)message, strlen(message));
			unsigned char* pHashBigEndian = std::get<0>(result);
			...
			ECDSA myEcDsa(ecKeyPair);
			std::string signature = myEcDsa.Sign(pHashBigEndian, len, false);
			bool valid = verifyECDsa(myEcDsa, pHashBigEndian, len, signature, BCRYPT_ECC_CURVE_NISTP224);
			delete[] pHashBigEndian;
			Assert::IsTrue(valid);
		}
		TEST_METHOD(TestSignatureECDSAVerifyNISTP224SHA256ValidRandomPrivateKey)
		{
			char* message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
			std::tuple<unsigned char*, ULONG> result = hash((unsigned char*)message, strlen(message));
			unsigned char* pHashBigEndian = std::get<0>(result);
			...
			ECKeyPair ecKeyPair(myEC);
			ECDSA myEcDsa(ecKeyPair);
			std::string signature = signECDsa(myEcDsa, pHashBigEndian, len, BCRYPT_ECC_CURVE_NISTP224);
			bool valid = myEcDsa.Verify( pHashBigEndian, len, signature, false);
			delete[] pHashBigEndian;
			Assert::IsTrue(valid);
		}
		TEST_METHOD(TestSignatureECDSASignNISTP384SHA256ValidRandomPrivateKey)
		{
			char* message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
			std::tuple<unsigned char*, ULONG> result = hash((unsigned char*)message, strlen(message));
			unsigned char* pHashBigEndian = std::get<0>(result);
			...
			ECDSA myEcDsa(ecKeyPair);
			std::string signature = myEcDsa.Sign(pHashBigEndian, len, false);
			bool valid = verifyECDsa(myEcDsa, pHashBigEndian, len, signature, BCRYPT_ECC_CURVE_NISTP384);
			delete[] pHashBigEndian;
			Assert::IsTrue(valid);
		}
		TEST_METHOD(TestSignatureECDSAVerifyNISTP384SHA256ValidRandomPrivateKey)
		{
			char* message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
			std::tuple<unsigned char*, ULONG> result = hash((unsigned char*)message, strlen(message));
			unsigned char* pHashBigEndian = std::get<0>(result);
			...
			ECKeyPair ecKeyPair(myEC);
			ECDSA myEcDsa(ecKeyPair);
			std::string signature = signECDsa(myEcDsa, pHashBigEndian, len, BCRYPT_ECC_CURVE_NISTP384);
			bool valid = myEcDsa.Verify(pHashBigEndian, len, signature, false);
			delete[] pHashBigEndian;
			Assert::IsTrue(valid);
		}
		TEST_METHOD(TestECDHSharedSecretNISTP384Bcrypt)
		{
			...
			ECKeyPair ecKeyPair1(myEC);
			ECKeyPair ecKeyPair2(myEC);
			ModNumber exp = GetSecretECDHAgreement(ecKeyPair1, ecKeyPair2, BCRYPT_ECC_CURVE_NISTP384);
		...
		TEST_METHOD(TestDHSharedSecretMODP)
		{
			...
			exp = GetSecretDHAgreement(dhParameters2, dhParameters1);
			calculatedSharedSecret = CalculateDHSharedSecret(dhParameters2, dhParameters1);
			Assert::IsTrue(exp == calculatedSharedSecret);
#endif
		}


		TEST_CLASS_INITIALIZE(TestGenerateKeys)
		{
		...
		TEST_CLASS_CLEANUP(TestDeleteKeys)
		{
			NCRYPT_PROV_HANDLE provHandle;
			NCryptOpenStorageProvider(&provHandle, NULL, 0);
#if (MAXMOD == 4096/8)
			DeleteKey(L"MyCoolRSASignatureKey4096", provHandle, AT_SIGNATURE);

#elif (MAXMOD == 2048/8)
			DeleteKey(L"MyCoolRSASignatureKey2048", provHandle, AT_SIGNATURE);

#elif (MAXMOD == 1024/8)
			DeleteKey(L"MyCoolRSASignatureKey1024", provHandle, AT_SIGNATURE);
#endif
#if (MAXMOD == 4096/8)
			DeleteKey(L"MyCoolRSAKey4096", provHandle, AT_KEYEXCHANGE);

#elif (MAXMOD == 2048/8)
			DeleteKey(L"MyCoolRSAKey2048", provHandle, AT_KEYEXCHANGE);

#elif (MAXMOD == 1024/8)
			DeleteKey(L"MyCoolRSAKey1024", provHandle, AT_KEYEXCHANGE);
#endif
#if (MAXMOD == 3072/8)
