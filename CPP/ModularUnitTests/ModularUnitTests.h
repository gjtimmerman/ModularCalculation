...
namespace ModularUnitTests
{
	...
	public:
		...
		TEST_METHOD(TestDHTwoSharedSecretsMODP)
		{
			...
			ModNumber sharedSecret1 = CalculateDHSharedSecret(dhParameters1, dhParameters2);
			ModNumber sharedSecret2 = CalculateDHSharedSecret(dhParameters2, dhParameters1);
