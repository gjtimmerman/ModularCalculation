...
namespace ModularUnitTests
{
	...
	public:
		...
		TEST_METHOD(TestGetRSAKey)
		{
			...
			ModNumber mModulusProduct = mPrime1Exp * mPrime2Exp;
			ModNumber Pminus1 = mPrime1Exp - ModNumber(1ull);
			ModNumber Qminus1 = mPrime2Exp - ModNumber(1ull);
			ModNumber PhiPQ = Pminus1 * Qminus1;
			MultGroupMod mgmPhiPQ(PhiPQ);
			ModNumber PrivExpCalc = mgmPhiPQ.Inverse(mExponentExp);
			...
			Assert::IsTrue(DpCalc == mExp1Exp);
			Assert::IsTrue(DqCalc == mExp2Exp);
		}
