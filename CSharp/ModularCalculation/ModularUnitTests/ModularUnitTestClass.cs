...
namespace ModularUnitTests
{
    ...
    public void TestMultiplyMultGroupModSixteenBlock9sDecBySixteenBlock9sDecResultLessMod()
    {
        ...
        [TestMethod]
        public void TestECAddCurveAMinus2B0Point00AndPoint22IsPointMinus1And1()
        {
            ModNumber p = new ModNumber(65535ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            g.IsAtInfinity = true;
            ModNumber mzero = new ModNumber(0ul);
            ...
            pt1.y = mzero;
            ModularCalculation.ECPoint pt2 = new ModularCalculation.ECPoint();
            pt2.x = new ModNumber(2ul);
            pt2.y = new ModNumber(2ul);
            ModularCalculation.ECPoint exp = new ModularCalculation.ECPoint();
            exp.x = mgm.Diff(new ModNumber(0ul), new ModNumber(1ul));
            exp.y = new ModNumber(1ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));

        }
        [TestMethod]
        public void TestECIsOnCurveP19AMinus7B10Point12()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            g.IsAtInfinity = true;
            ModNumber mzero = new ModNumber(0ul);
            EC myEC = new EC(mgm, g, mzero, mgm.Diff(mzero, new ModNumber(7ul)), new ModNumber(10ul));
            ModularCalculation.ECPoint pt1 = new ModularCalculation.ECPoint();
            pt1.x = new ModNumber(1ul);
            pt1.y = new ModNumber(2ul);
            Assert.IsTrue(myEC.IsOnCurve(pt1));

        }
        [TestMethod]
        public void TestECIsOnCurveP19AMinus7B10Point1And17()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            ModularCalculation.ECPoint pt1 = new ModularCalculation.ECPoint();
            pt1.x = new ModNumber(1ul);
            pt1.y = new ModNumber(17ul);
            Assert.IsTrue(myEC.IsOnCurve(pt1));

        }
        [TestMethod]
        public void TestECIsOnCurveP19AMinus7B10Point22()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            EC myEC = new EC(mgm, g, mzero, mgm.Diff(mzero, new ModNumber(7ul)), new ModNumber(10ul));
            ModularCalculation.ECPoint pt1 = new ModularCalculation.ECPoint();
            pt1.x = new ModNumber(2ul);
            pt1.y = new ModNumber(2ul);
            Assert.IsTrue(myEC.IsOnCurve(pt1));

        }
        [TestMethod]
        public void TestECIsOnCurveP19AMinus7B10Point2And17()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
        ...
        [TestMethod]
        public void TestECAddCurveP19AMinus7B10Point22AndPoint2And17IsPtAtInfinity()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
        ...
        [TestMethod]
        public void TestECAddCurveP19AMinus7B10Point12AndPoint2And17IsPt13And8()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            pt2.y = new ModNumber(17ul);
            ModularCalculation.ECPoint exp = new ModularCalculation.ECPoint();
            exp.x = new ModNumber(13ul);
            exp.y = new ModNumber(8ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));

        }
        [TestMethod]
        public void TestECAddCurveP19AMinus7B10Point1And17AndPoint2And17IsPt16And2()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            pt2.y = new ModNumber(17ul);
            ModularCalculation.ECPoint exp = new ModularCalculation.ECPoint();
            exp.x = new ModNumber(16ul);
            exp.y = new ModNumber(2ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));

        }
        [TestMethod]
        public void TestECAddCurveP19AMinus7B10Point1And17AndPoint22IsPt13And11()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            ModularCalculation.ECPoint exp = new ModularCalculation.ECPoint();
            exp.x = new ModNumber(13ul);
            exp.y = new ModNumber(11ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));

        }
        [TestMethod]
        public void TestECAddCurveP19AMinus7B10Point1And17AndPoint97IsPt70()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            pt1.y = new ModNumber(17ul);
            ModularCalculation.ECPoint pt2 = new ModularCalculation.ECPoint();
            pt2.x = new ModNumber(9ul);
            pt2.y = new ModNumber(7ul);
            ModularCalculation.ECPoint exp = new ModularCalculation.ECPoint();
            exp.x = new ModNumber(7ul);
            exp.y = new ModNumber(0ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));

        }
        [TestMethod]
        public void TestECAddCurveP19AMinus7B10Point1And17Times3EqualToPt1And17AddPt18And15()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            pt1.y = new ModNumber(17ul);
            ModularCalculation.ECPoint exp = new ModularCalculation.ECPoint();
            exp.x = new ModNumber(9ul);
            exp.y = new ModNumber(7ul);
            Assert.IsTrue(exp == myEC.Mult(pt1, new ModNumber(3)));
            ModularCalculation.ECPoint pt2 = new ModularCalculation.ECPoint();
            pt2.x = new ModNumber(18ul);
            pt2.y = new ModNumber(4ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));

        }
        [TestMethod]
        public void TestECAddCurveP19AMinus7B10Point1And17Times4EqualToPt1And17AddPt12EqualToPt1And17Times2Times2()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            exp.x = new ModNumber(7ul);
            exp.y = new ModNumber(0ul);
            Assert.IsTrue(exp == myEC.Mult(pt1, new ModNumber(4)));
            ModularCalculation.ECPoint pt2 = new ModularCalculation.ECPoint();
            pt2.x = new ModNumber(9ul);
            pt2.y = new ModNumber(7ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));
            ModularCalculation.ECPoint pt3 = new ModularCalculation.ECPoint();
            pt3.x = new ModNumber(18ul);
            pt3.y = new ModNumber(4ul);
            Assert.IsTrue(exp == myEC.Times2(pt3));

        }
        [TestMethod]
        public void TestECMultCurveP19AMinus7B10Point1And17SubGroup()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            EC myEC = new EC(mgm, g, mzero, mgm.Diff(mzero, new ModNumber(7ul)), new ModNumber(10ul));
            ModularCalculation.ECPoint pt = new ModularCalculation.ECPoint();
            pt.x = new ModNumber(1ul);
            pt.y = new ModNumber(17ul);
            ModularCalculation.ECPoint exp = new ModularCalculation.ECPoint();
            exp.x = new ModNumber(18ul);
            exp.y = new ModNumber(4ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(2)));
            exp.x = new ModNumber(9ul);
            exp.y = new ModNumber(7ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(3)));
            exp.x = new ModNumber(7ul);
            exp.y = new ModNumber(0ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(4)));
            exp.x = new ModNumber(9ul);
            exp.y = new ModNumber(12ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(5)));
            exp.x = new ModNumber(18ul);
            exp.y = new ModNumber(15ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(6)));
            exp.x = new ModNumber(1ul);
            exp.y = new ModNumber(2ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(7)));
            exp.IsAtInfinity = true;
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(8)));

        }
        [TestMethod]
        public void TestECMultCurveP19AMinus7B10Point1And17CoSet1()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));
            pt1 = exp;
            exp.x = new ModNumber(10ul);
            exp.y = new ModNumber(16ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));
            pt1 = exp;
            exp.x = new ModNumber(12ul);
            exp.y = new ModNumber(18ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));
            pt1 = exp;
            exp.x = new ModNumber(17ul);
            exp.y = new ModNumber(4ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));
            pt1 = exp;
            exp.x = new ModNumber(5ul);
            exp.y = new ModNumber(10ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));
            pt1 = exp;
            exp.x = new ModNumber(3ul);
            exp.y = new ModNumber(15ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));
            pt1 = exp;
            exp.x = new ModNumber(16ul);
            exp.y = new ModNumber(17ul);
            Assert.IsTrue(exp == myEC.Add(pt1, pt2));
            pt1 = exp;
            exp.x = new ModNumber(2ul);
            exp.y = new ModNumber(2ul);
        ...
        [TestMethod]
        public void TestECMultCurveP19AMinus7B10Point1And17CoSet2()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
        ...
        [TestMethod]
        public void TestECMultCurveP19AMinus7B10Point22SubGroup()
        {
            ModNumber p = new ModNumber(19ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            exp.x = new ModNumber(9ul);
            exp.y = new ModNumber(12ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(9)));
            exp.x = new ModNumber(5ul);
            exp.y = new ModNumber(10ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(10)));
            exp.x = new ModNumber(17ul);
            exp.y = new ModNumber(15ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(11)));
            exp.x = new ModNumber(7ul);
            exp.y = new ModNumber(0ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(12)));
            exp.x = new ModNumber(17ul);
            exp.y = new ModNumber(4ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(13)));
            exp.x = new ModNumber(5ul);
            exp.y = new ModNumber(9ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(14)));
            exp.x = new ModNumber(9ul);
            exp.y = new ModNumber(7ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(15)));
            exp.x = new ModNumber(12ul);
            exp.y = new ModNumber(18ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(16)));
            exp.x = new ModNumber(3ul);
            exp.y = new ModNumber(4ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(17)));
            exp.x = new ModNumber(18ul);
            exp.y = new ModNumber(4ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(18)));
            exp.x = new ModNumber(10ul);
            exp.y = new ModNumber(16ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(19)));
            exp.x = new ModNumber(16ul);
            exp.y = new ModNumber(2ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(20)));
            exp.x = new ModNumber(1ul);
            exp.y = new ModNumber(17ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(21)));
            exp.x = new ModNumber(13ul);
            exp.y = new ModNumber(11ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(22)));
            exp.x = new ModNumber(2ul);
            exp.y = new ModNumber(17ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(23)));
            exp.IsAtInfinity = true;
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(24)));

        }
        [TestMethod]
        public void TestECMultCurveP97AMinus7B10Point12IsOnCurve()
        {
            ModNumber p = new ModNumber(97ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            g.IsAtInfinity = true;
            ModNumber mzero = new ModNumber(0ul);
        ...
        [TestMethod]
        public void TestECMultCurveP97AMinus7B10Point22IsOnCurve()
        {
            ModNumber p = new ModNumber(97ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
        ...
        [TestMethod]
        public void TestECMultCurveP97AMinus7B10Point12SubGroup()
        {
            ModNumber p = new ModNumber(97ul);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            pt.y = new ModNumber(2ul);
            ModularCalculation.ECPoint exp = new ModularCalculation.ECPoint();
            exp.x = new ModNumber(96ul);
            exp.y = new ModNumber(93ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(2)));
            exp.x = new ModNumber(9ul);
            exp.y = new ModNumber(71ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(3)));
            exp.x = new ModNumber(75ul);
            exp.y = new ModNumber(63ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(4)));
            exp.x = new ModNumber(24ul);
            exp.y = new ModNumber(59ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(5)));
            exp.x = new ModNumber(29ul);
            exp.y = new ModNumber(72ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(6)));
            exp.x = new ModNumber(49ul);
            exp.y = new ModNumber(72ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(7)));
            exp.x = new ModNumber(53ul);
            exp.y = new ModNumber(3ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(8)));
            exp.x = new ModNumber(51ul);
            exp.y = new ModNumber(53ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(9)));
            exp.x = new ModNumber(37ul);
            exp.y = new ModNumber(35ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(10)));
            exp.x = new ModNumber(43ul);
            exp.y = new ModNumber(8ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(11)));
            exp.x = new ModNumber(55ul);
            exp.y = new ModNumber(18ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(12)));
            exp.x = new ModNumber(19ul);
            exp.y = new ModNumber(25ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(13)));
            exp.x = new ModNumber(46ul);
            exp.y = new ModNumber(86ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(14)));
            exp.x = new ModNumber(44ul);
            exp.y = new ModNumber(60ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(15)));
            exp.x = new ModNumber(63ul);
            exp.y = new ModNumber(61ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(16)));
            exp.x = new ModNumber(36ul);
            exp.y = new ModNumber(57ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(17)));
            exp.x = new ModNumber(11ul);
            exp.y = new ModNumber(10ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(18)));
            exp.x = new ModNumber(74ul);
            exp.y = new ModNumber(56ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(19)));
            exp.x = new ModNumber(21ul);
            exp.y = new ModNumber(43ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(20)));
            exp.x = new ModNumber(13ul);
            exp.y = new ModNumber(51ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(21)));
            exp.x = new ModNumber(2ul);
            exp.y = new ModNumber(2ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(22)));
            exp.x = new ModNumber(94ul);
            exp.y = new ModNumber(95ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(23)));
            exp.x = new ModNumber(3ul);
            exp.y = new ModNumber(93ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(24)));
            exp.x = new ModNumber(5ul);
            exp.y = new ModNumber(10ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(25)));
            exp.x = new ModNumber(95ul);
            exp.y = new ModNumber(4ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(26)));
            exp.x = new ModNumber(23ul);
            exp.y = new ModNumber(45ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(27)));
            exp.x = new ModNumber(67ul);
            exp.y = new ModNumber(63ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(28)));
            exp.x = new ModNumber(79ul);
            exp.y = new ModNumber(67ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(29)));
            exp.x = new ModNumber(15ul);
            exp.y = new ModNumber(51ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(30)));
            exp.x = new ModNumber(69ul);
            exp.y = new ModNumber(51ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(31)));
            exp.x = new ModNumber(52ul);
            exp.y = new ModNumber(34ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(32)));
            exp.x = new ModNumber(41ul);
            exp.y = new ModNumber(68ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(33)));
            exp.x = new ModNumber(73ul);
            exp.y = new ModNumber(15ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(34)));
            exp.x = new ModNumber(54ul);
            exp.y = new ModNumber(76ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(35)));
            exp.x = new ModNumber(31ul);
            exp.y = new ModNumber(22ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(36)));
            exp.x = new ModNumber(87ul);
            exp.y = new ModNumber(70ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(37)));
            exp.x = new ModNumber(40ul);
            exp.y = new ModNumber(1ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(38)));
            exp.x = new ModNumber(81ul);
            exp.y = new ModNumber(10ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(39)));
            exp.x = new ModNumber(80ul);
            exp.y = new ModNumber(58ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(40)));
            exp.x = new ModNumber(64ul);
            exp.y = new ModNumber(0ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(41)));
            exp.x = new ModNumber(80ul);
            exp.y = new ModNumber(39ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(42)));
            exp.x = new ModNumber(81ul);
            exp.y = new ModNumber(87ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(43)));
            exp.x = new ModNumber(40ul);
            exp.y = new ModNumber(96ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(44)));
            exp.x = new ModNumber(87ul);
            exp.y = new ModNumber(27ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(45)));
            exp.x = new ModNumber(31ul);
            exp.y = new ModNumber(75ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(46)));
            exp.x = new ModNumber(54ul);
            exp.y = new ModNumber(21ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(47)));
            exp.x = new ModNumber(73ul);
            exp.y = new ModNumber(82ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(48)));
            exp.x = new ModNumber(41ul);
            exp.y = new ModNumber(29ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(49)));
            exp.x = new ModNumber(52ul);
            exp.y = new ModNumber(63ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(50)));
            exp.x = new ModNumber(69ul);
            exp.y = new ModNumber(46ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(51)));
            exp.x = new ModNumber(15ul);
            exp.y = new ModNumber(46ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(52)));
            exp.x = new ModNumber(79ul);
            exp.y = new ModNumber(30ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(53)));
            exp.x = new ModNumber(67ul);
            exp.y = new ModNumber(34ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(54)));
            exp.x = new ModNumber(23ul);
            exp.y = new ModNumber(52ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(55)));
            exp.x = new ModNumber(95ul);
            exp.y = new ModNumber(93ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(56)));
            exp.x = new ModNumber(5ul);
            exp.y = new ModNumber(87ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(57)));
            exp.x = new ModNumber(3ul);
            exp.y = new ModNumber(4ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(58)));
            exp.x = new ModNumber(94ul);
            exp.y = new ModNumber(2ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(59)));
            exp.x = new ModNumber(2ul);
            exp.y = new ModNumber(95ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(60)));
            exp.x = new ModNumber(13ul);
            exp.y = new ModNumber(46ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(61)));
            exp.x = new ModNumber(21ul);
            exp.y = new ModNumber(54ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(62)));
            exp.x = new ModNumber(74ul);
            exp.y = new ModNumber(41ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(63)));
            exp.x = new ModNumber(11ul);
            exp.y = new ModNumber(87ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(64)));
            exp.x = new ModNumber(36ul);
            exp.y = new ModNumber(40ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(65)));
            exp.x = new ModNumber(63ul);
            exp.y = new ModNumber(36ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(66)));
            exp.x = new ModNumber(44ul);
            exp.y = new ModNumber(37ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(67)));
            exp.x = new ModNumber(46ul);
            exp.y = new ModNumber(11ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(68)));
            exp.x = new ModNumber(19ul);
            exp.y = new ModNumber(72ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(69)));
            exp.x = new ModNumber(55ul);
            exp.y = new ModNumber(79ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(70)));
            exp.x = new ModNumber(43ul);
            exp.y = new ModNumber(89ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(71)));
            exp.x = new ModNumber(37ul);
            exp.y = new ModNumber(62ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(72)));
            exp.x = new ModNumber(51ul);
            exp.y = new ModNumber(44ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(73)));
            exp.x = new ModNumber(53ul);
            exp.y = new ModNumber(94ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(74)));
            exp.x = new ModNumber(49ul);
            exp.y = new ModNumber(25ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(75)));
            exp.x = new ModNumber(29ul);
            exp.y = new ModNumber(25ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(76)));
            exp.x = new ModNumber(24ul);
            exp.y = new ModNumber(38ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(77)));
            exp.x = new ModNumber(75ul);
            exp.y = new ModNumber(34ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(78)));
            exp.x = new ModNumber(9ul);
            exp.y = new ModNumber(26ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(79)));
            exp.x = new ModNumber(96ul);
            exp.y = new ModNumber(4ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(80)));
            exp.x = new ModNumber(1ul);
            exp.y = new ModNumber(95ul);
            Assert.IsTrue(exp == myEC.Mult(pt, new ModNumber(81)));
            exp.IsAtInfinity = true;
        ...
        public void TestSignatureECDSASecp256k1SignAndVerifySHA256InValid()
        {
            ...
            wrongHash[0]++;
            bool valid = ecDsa.Verify(wrongHash, signature);
        ...
        [TestMethod]
        public void TestSignatureECDSASignSHA256Valid()
        {
            string message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
            byte[] messageBytes = Encoding.ASCII.GetBytes(message);
            SHA256 sha256 = SHA256.Create();
        ...
        [TestMethod]
        public void TestSignatureECDSASignSHA256InValid()
        {
            string message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
            byte[] messageBytes = Encoding.ASCII.GetBytes(message);
            SHA256 sha256 = SHA256.Create();
            ...
            ECDSA ecDsa = new ECDSA(ecKeyPair);
            byte[] signature = ecDsa.Sign(hash);
            bool valid = ecDsaCng.VerifyHash(invalidHash, signature);
            Assert.IsFalse(valid);
        }
        [TestMethod]
        public void TestSignatureECDSASignSHA256CalculatedPubKey()
        {
            string message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
            byte[] messageBytes = Encoding.ASCII.GetBytes(message);
            SHA256 sha256 = SHA256.Create();
        ...
        [TestMethod]
        public void TestSignatureECDSASignSHA256CalculatedPubAndPrivateKey()
        {
            string message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
            byte[] messageBytes = Encoding.ASCII.GetBytes(message);
            SHA256 sha256 = SHA256.Create();
        ...
        public void TestSignatureECDSANISTP521SignSHA256ValidRandomPrivateKey()
        {
            ...
            ECKeyPair ecKeyPair = new ECKeyPair(myEC);
            ECDSA ecDsa = new ECDSA(ecKeyPair);
            ECDsaCng ecDsaCng = ecKeyPair.ImportECKeyPair("ECDSA_P521");
            byte[] signature = ecDsa.Sign(hash);
            bool valid = ecDsaCng.VerifyHash(hash, signature);
            Assert.IsTrue(valid);
        }
        [TestMethod]
        public void TestSignatureECDSANISTP521SignSHA256ValidGivenPrivateKeyCalculatedPubKey()
        {
            string message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
            byte[] messageBytes = Encoding.ASCII.GetBytes(message);
            SHA256 sha256 = SHA256.Create();
            ...
            ModNumber b = ModNumber.Stomn("051953eb9618e1c9a1f929a21a0b68540eea2da725b99b315f3b8b489918ef109e156193951ec7e937b1652c0bd3bb1bf073573df883d2c34f1ef451fd46b503f00", 16);
            EC myEC = new EC(mgm, g, n, a, b);
            ModNumber privateKey = ModNumber.Stomn("", 16);
            ECKeyPair ecKeyPair = new ECKeyPair(myEC, privateKey);
            ECDSA ecDsa = new ECDSA(ecKeyPair);
            ECDsaCng ecDsaCng = ecKeyPair.ImportECKeyPair("ECDSA_P521");
            byte[] signature = ecDsa.Sign(hash);
        ...
        [TestMethod]
        public void TestSignatureECDSANISTP521SignSHA256InValidRandomPrivateKey()
        {
            string message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
            byte[] messageBytes = Encoding.ASCII.GetBytes(message);
            SHA256 sha256 = SHA256.Create();
        ...
        [TestMethod]
        public void TestSignatureECDSANISTP521VerifySHA256ValidRandomPrivateKey()
        {
            string message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
            byte[] messageBytes = Encoding.ASCII.GetBytes(message);
            SHA256 sha256 = SHA256.Create();
        ...
        [TestMethod]
        public void TestSignatureECDSANISTP521VerifySHA256InValidRandomPrivateKey()
        {
            string message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
            byte[] messageBytes = Encoding.ASCII.GetBytes(message);
            SHA256 sha256 = SHA256.Create();
        ...
        [TestMethod]
        public void TestSignatureECDSASignNISTP224SHA256ValidRandomPrivateKey()
        {
            string message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
            byte[] messageBytes = Encoding.ASCII.GetBytes(message);
            SHA256 sha256 = SHA256.Create();
            ...
            ECKeyPair ecKeyPair = new ECKeyPair(myEC);
            ECDSA ecDsa = new ECDSA(ecKeyPair);
            ECDsaCng ecDsaCng = ecKeyPair.ImportECKeyPair("nistP224");
            byte[] signature = ecDsa.Sign(hash);
            bool valid = ecDsaCng.VerifyHash(hash, signature);
            Assert.IsTrue(valid);
        }
        [TestMethod]
        public void TestSignatureECDSAVerifyNISTP224SHA256ValidRandomPrivateKey()
        {
            string message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
            byte[] messageBytes = Encoding.ASCII.GetBytes(message);
            SHA256 sha256 = SHA256.Create();
        ...
        [TestMethod]
        public void TestSignatureECDSASignNISTP384SHA256ValidRandomPrivateKey()
        {
            string message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
            byte[] messageBytes = Encoding.ASCII.GetBytes(message);
            SHA256 sha256 = SHA256.Create();
            ...
            ECKeyPair ecKeyPair = new ECKeyPair(myEC);
            ECDSA ecDsa = new ECDSA(ecKeyPair);
            ECDsaCng ecDsaCng = ecKeyPair.ImportECKeyPair("nistP384");
            byte[] signature = ecDsa.Sign(hash);
            bool valid = ecDsaCng.VerifyHash(hash, signature);
            Assert.IsTrue(valid);
        }
        [TestMethod]
        public void TestSignatureECDSAVerifyNISTP384SHA256ValidRandomPrivateKey()
        {
            string message = "Dit is een test om te zien of een signature geverifieerd kan worden!";
            byte[] messageBytes = Encoding.ASCII.GetBytes(message);
            SHA256 sha256 = SHA256.Create();
        ...
        [TestMethod]
        public void TestECDHSharedSecretNISTP384Ncrypt()
        {
            ModNumber p = ModNumber.Stomn("fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffeffffffff0000000000000000ffffffff", 16);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            ModNumber b = ModNumber.Stomn("b3312fa7e23ee7e4988e056be3f82d19181d9c6efe8141120314088f5013875ac656398d8a2ed19d2a85c8edd3ec2aef", 16);
            EC myEC = new EC(mgm, g, n, a, b);
            ECKeyPair ecKeyPair1 = new ECKeyPair(myEC);
            ECKeyPair ecKeyPair2 = new ECKeyPair(myEC);
            ModNumber sharedSecret = ECKeyPair.CalculateECDHSharedSecret(ecKeyPair1, ecKeyPair2);
            byte[] sharedSecretBigEndian = sharedSecret.convertEndianess();
            SHA384 sha384 = SHA384.Create();
            byte[] sharedSecretHashed = sha384.ComputeHash(sharedSecretBigEndian);
            byte[] expSharedSecretBigEndian = ECKeyPair.GetSecretECDHAgreement(ecKeyPair1, ecKeyPair2, "nistP384", new byte[] { 0x45, 0x43, 0x4B, 0x33 });
            bool sameSecret = true;
            for (int i = 0; i < expSharedSecretBigEndian.Length; i++)
                if (expSharedSecretBigEndian[i] != sharedSecretHashed[i])
                {
                    sameSecret = false;
                    break;
                }
            Assert.IsTrue(sameSecret);
        }
        [TestMethod]
        public void TestECDHSharedSecretNISTP256r1Ncrypt()
        {
            ModNumber p = ModNumber.Stomn("ffffffff00000001000000000000000000000000ffffffffffffffffffffffff", 16);
            MultGroupMod mgm = new MultGroupMod(p);
            ModularCalculation.ECPoint g = new ModularCalculation.ECPoint();
            ...
            ModNumber n = ModNumber.Stomn("ffffffff00000000ffffffffffffffffbce6faada7179e84f3b9cac2fc632551", 16);
            ModNumber mzero = new ModNumber(0ul);
            ModNumber a = ModNumber.Stomn("ffffffff00000001000000000000000000000000fffffffffffffffffffffffc", 16);
            ModNumber b = ModNumber.Stomn("5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b", 16);
            EC myEC = new EC(mgm, g, n, a, b);
            ECKeyPair ecKeyPair1 = new ECKeyPair(myEC);
            ECKeyPair ecKeyPair2 = new ECKeyPair(myEC);
            ...
            SHA384 sha384 = SHA384.Create();
            byte[] sharedSecretHashed = sha384.ComputeHash(sharedSecretBigEndian);
            byte[] expSharedSecretBigEndian = ECKeyPair.GetSecretECDHAgreement(ecKeyPair1, ecKeyPair2, "secp256r1", new byte[] { 0x45, 0x43, 0x4B, 0x31 });
            bool sameSecret = true;
            for (int i = 0; i < expSharedSecretBigEndian.Length; i++)
                if (expSharedSecretBigEndian[i] != sharedSecretHashed[i])
                {
